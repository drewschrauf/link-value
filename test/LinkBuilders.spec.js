...
describe('LinkBuilder', () => {
  ...
  describe('makeCheckedLink', () => {
    ...
    it('should return a checked and onChange', () => {
      const r = makeCheckedLink(vc, c, 'a');
